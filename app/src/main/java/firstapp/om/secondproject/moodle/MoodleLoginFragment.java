         ...
         login.setOnClickListener(new View.OnClickListener() {
             ...
             public void onClick(View view) {
                 ...
                 for (Student st:studentArrayList){
                      dUser=st.getUser_id();
                      dPass=st.getPassword();
                      if (user.equals(dUser) && pass.equals(dPass)){
                          Toast.makeText(getActivity(),dUser+dPass,Toast.LENGTH_LONG).show();
                          return;
                      }
                      else{
                          Toast.makeText(getActivity(),"Sorry You are not Registered! Please Register First!!",Toast.LENGTH_LONG).show();
